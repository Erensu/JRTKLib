...
* notes  : obs codes are based on reference [6] and qzss extension
*-----------------------------------------------------------------------------*/
    public static char *code2obs(int code, Integer freq)
    {
        if (freq) *freq=0;
     ...
     *-----------------------------------------------------------------------------*/
    public static int getcodepri(int sys, unsigned char code, final char *opt)
    {
        final char *p,*optstr;
        char *obs,str[8]="";
        int i,j;
     ...
     *-----------------------------------------------------------------------------*/
    public static unsigned int getbitu(final unsigned char *buff, int pos, int len)
    {
        unsigned int bits=0;
        int i;
    ...
    public static int getbits(final unsigned char *buff, int pos, int len)
    {
    ...
    *day=epoch2time(ep);
     ...
     *-----------------------------------------------------------------------------*/
    public static char *time_str(gtime_t t, int n)
    {
        static char buff[64];
        time2str(t,buff,n);
        return buff;
...
#define Rx(t,X) do { \
    ...
    *deps*=1E-4*AS2R;
     ...
     *          not thread-safe
     *-----------------------------------------------------------------------------*/
    public static void eci2ecef(gtime_t tutc, final double *erpv, double *U, double *gmst)
    {
    final double ep2000[]={2000,1,1,12,0,0};
    ...
    static void addpcv(final pcv_t *pcv, pcvs_t *pcvs)
    {
        pcv_t *pcvs_pcv;
    ...
    static int readngspcv(final char *file, pcvs_t *pcvs)
    {
        FILE *fp;
    ...
    /* read antex file ----------------------------------------------------------*/
    static int readantex(final char *file, pcvs_t *pcvs)
    {
        FILE *fp;
        static final pcv_t pcv0={0};
        pcv_t pcv;
     ...
     *-----------------------------------------------------------------------------*/
    public static int readpcv(final char *file, pcvs_t *pcvs)
    {
        pcv_t *pcv;
        char *ext;
        int i,stat;
     ...
     *-----------------------------------------------------------------------------*/
    public static pcv_t *searchpcv(int sat, final char *type, gtime_t time,
                        final pcvs_t *pcvs)
    {
        pcv_t *pcv;
     ...
     * return : status (1:ok,0:error)
     *-----------------------------------------------------------------------------*/
    public static int geterp(final erp_t *erp, gtime_t time, double *erpv)
    {
    ...
    *p='\0';
     ...
     *-----------------------------------------------------------------------------*/
    public static int reppath(final char *path, char *rpath, gtime_t time, final char *rov,
                   final char *base)
    {
     ...
     *-----------------------------------------------------------------------------*/
    public static int reppaths(final char *path, char *rpath[], int nmax, gtime_t ts,
                        gtime_t te, final char *rov, final char *base)
    {
        gtime_t time;
     ...
     *-----------------------------------------------------------------------------*/
    public static double satwavelen(int sat, int frq, final nav_t *nav)
    {
    final double freq_glo[]={FREQ1_GLO,FREQ2_GLO};
    final double dfrq_glo[]={DFRQ1_GLO,DFRQ2_GLO};
...
#define SQRT(x)     ((x)<0.0||(x)!=(x)?0.0:sqrt(x))
     ...
     *-----------------------------------------------------------------------------*/
    public static double ionmodel(gtime_t t, final double *ion, final double *pos,
                       final double *azel)
    {
    final double ion_default[]={ /* 2004/1/1 */
     ...
     *-----------------------------------------------------------------------------*/
    public static double tropmodel(gtime_t time, final double *pos, final double *azel,
                            double humi)
    {
     ...
     *-----------------------------------------------------------------------------*/
    public static void antmodel(final pcv_t *pcv, final double *del, final double *azel,
                         int opt, double *dant)
    {
     ...
     *-----------------------------------------------------------------------------*/
    public static int rtk_uncompress(final char *file, char *uncfile)
    {
        int stat=0;
